...
@Repository
public class SduNewsDAO {
    private static final String HASH_NAME = "rc_sdu_news";

    private final RedisTemplate template;

    public SduNewsDAO(@Qualifier("redisTemplate") RedisTemplate template) {
